...
namespace BasicProduct.DB
{
    public class DbHelperSQL
    {

        //Database connection strings
        public static readonly string ConnB2c = ConfigurationManager.ConnectionStrings["ConnStr"].ConnectionString;
        ...
        {
            return ExecuteDataTable(DbHelperSQL.ConnB2c, CommandType.StoredProcedure, commandText, commandParameters);
        }
        ...
        //{
        //    // Pass through the call providing null for the set of SqlParameters
        //    return ExecuteScalar(DbHelperSQL.ConnB2c, CommandType.StoredProcedure, commandText);
        //}
        ...
        #region lxh加
        // 以下为存储过程中输出参数的输出涵数
        public static ArrayList ExecuteNonQueryOut(string connectionString, string spName, params object[] parameterValues)
        {
            SqlParameter[] commandParameters = SqlHelperParameterCache.GetSpParameterSet(connectionString, spName);
